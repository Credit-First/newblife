...
export default function CreateRoomModal({ open, setOpen }: modalProps) {
    ...
    const createRoom = async () => {
        ...
        let totalSupply: any = roomCtx.totalSupply;
        roomCtx.addRoom({
            id: totalSupply + 1,
            topAddress: account,
            topCardList: selecetedCardList,
            state: false,
            turnMode: account,
            detail: 'waiting for'
        });
        ...
        // write function to the contract
        const roomId = totalSupply + 1;
        // write function to the contract

        notify('success', 'created room')
        setOpen(false);
                                ...
                                <div className="flex justify-center items-center">
                                    <div className="w-full mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        <div className='mt-6 flex'>
                                            <div className='w-1/4 border-pink-500 border-r-2 pr-4'>
                                            ...
                                            <div className="w-3/4 flex flex-wrap justify-start overflow-y-auto max-h-[500px] pl-4">
                                                {
